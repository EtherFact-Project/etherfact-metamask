...
- Add support for alternative ENS TLDs (EtherFact Name Service Top-Level Domains).
...
- Fix EtherFact JSON RPC Filters bug.
...
- Remove EtherFact Classic from provider menu.
...
- Add EtherFact Classic to provider menu
